...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-batman.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/train/batman.data', help='*.data path')
